  ...
  return (
    <>
      <form onSubmit={handelSignup} className='mt-24 flex flex-col  gap-4 w-[400px] mx-auto'>
        ...
        <input ref={email} className='border-2 theme-bg-gray rounded px-2 py-px border-gray-500/30' type="email" required name='email' autoComplete='username'  placeholder='anuj@email.com' />
